...
int acharMenorOuIgual(int array[], int esquerda, int direita, int chave) {
    ...
    if (array[meio] <= chave) {
        int antes = acharMenorOuIgual(array, meio + 1, direita, chave);
...
int main(void) {
    ...
    std::cout << "Q1 - Testes 1: buscando elementos que existem no array."
              << std::endl;
    ...
    std::cout << "\nQ1 - Testes 2: buscando elementos que não existem no "
                 "array, mas que existe no array um menor do que o buscado."
              << std::endl;
    ...
    std::cout << "\nQ1 - Testes 3: buscando elemento que não existe no array, "
                 "e que não existe no array um menor do que o buscado."
              << std::endl;
