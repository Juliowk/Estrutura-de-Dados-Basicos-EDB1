...
public:
    ...
    {// Begin ​
        if (this->quantidade == 0) throw std::underflow_error("Fila vazia.");
        return this->elementos[this->inicio];
    }// End

    void enfileirar(T elemento)
    {// Begin
        if (this->quantidade == this->capacidade) throw std::overflow_error("Fila já se encontra cheia.");
    ...
    {// Begin ​
        ...
        auto resultado = this->elementos[this->inicio];
