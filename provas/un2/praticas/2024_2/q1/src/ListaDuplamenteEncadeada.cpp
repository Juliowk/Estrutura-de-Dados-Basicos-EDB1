...
ListaDuplamenteEncadeada::ListaDuplamenteEncadeada() { this->init(); }
...
int ListaDuplamenteEncadeada::tamanho(void) { return this->quantidade; }

bool ListaDuplamenteEncadeada::vazia(void) { return this->tamanho() == 0; }
